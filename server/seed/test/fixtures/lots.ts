...
export async function seedLots() {
  ...
  await db.insert(schema.receivingRecords).values([
    ...
    { id: seedIds.receivingRecords.uaApproved,    lotId: seedIds.lots.uaApproved,    uniqueIdentifier: "RCV-20260301-001", supplierId: seedIds.suppliers.primaryUA,  dateReceived: "2026-03-01", quantityReceived: "25000", uom: "g",   status: "APPROVED",  qcDisposition: "APPROVED",  qcReviewedBy: { userId: seedIds.users.carrieTreat, fullName: "Carrie Treat", title: "QC / PCQI" }, qcNotes: "All COAs pass" },
    { id: seedIds.receivingRecords.uaRejected,    lotId: seedIds.lots.uaRejected,    uniqueIdentifier: "RCV-20260215-001", supplierId: seedIds.suppliers.primaryUA,  dateReceived: "2026-02-15", quantityReceived: "25000", uom: "g",   status: "REJECTED",  qcDisposition: "REJECTED",  qcReviewedBy: { userId: seedIds.users.carrieTreat, fullName: "Carrie Treat", title: "QC / PCQI" }, qcNotes: "Lead OOS: 1.2 µg/g" },
    ...
    { id: seedIds.receivingRecords.fgProUro,      lotId: seedIds.lots.fgProUro,      uniqueIdentifier: "RCV-20260315-001", dateReceived: "2026-03-15",               quantityReceived: "1000",  uom: "pcs", status: "APPROVED",  qcDisposition: "APPROVED",  qcReviewedBy: { userId: seedIds.users.carrieTreat, fullName: "Carrie Treat", title: "QC / PCQI" } },
    { id: seedIds.receivingRecords.fgNmn,         lotId: seedIds.lots.fgNmn,         uniqueIdentifier: "RCV-20260315-002", dateReceived: "2026-03-15",               quantityReceived: "500",   uom: "pcs", status: "APPROVED",  qcDisposition: "APPROVED",  qcReviewedBy: { userId: seedIds.users.carrieTreat, fullName: "Carrie Treat", title: "QC / PCQI" } },
  ]).onConflictDoNothing();
