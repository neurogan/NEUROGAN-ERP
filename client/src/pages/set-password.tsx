...
export default function SetPassword() {
  ...
  // Common cause: an email client (Outlook safelinks, mobile webview) mangled the
  // hash fragment so the token/email didn't survive transit.
  if (!token || !email) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-background px-4">
        <div className="w-full max-w-sm space-y-6">
          ...
          <Card data-testid="set-password-missing-params">
            <CardHeader className="pb-3">
              <CardTitle className="text-base">Invite link is incomplete</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <Alert variant="destructive">
                <AlertDescription className="text-sm">
                  This invite link is missing required information. Some email apps
                  (especially mobile apps and corporate inboxes) can strip parts of
                  the link.
                </AlertDescription>
              </Alert>
              <div className="text-sm text-muted-foreground space-y-2">
                ...
                <ul className="list-disc pl-4 space-y-1">
                  <li>Open the invite email in a desktop browser (Chrome, Firefox, Safari)</li>
